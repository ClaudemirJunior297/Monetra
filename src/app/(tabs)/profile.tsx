...
const styles = StyleSheet.create({
  ...
  header: { alignItems: "center", padding: spacing.xl, backgroundColor: colors.card, borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  name: { ...typography.title, fontSize: 24, color: colors.white, marginBottom: spacing.xs, textAlign: "center" },
  email: { ...typography.body, color: colors.textSecondary, textAlign: "center" },
  panel: { margin: spacing.lg, padding: spacing.lg, backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border, gap: spacing.md },
  infoRow: { gap: spacing.xs },
  infoLabel: { ...typography.caption, color: colors.textSecondary },
  infoValue: { ...typography.body, color: colors.text },
  menu: { padding: spacing.lg },
  menuItem: { flexDirection: "row", alignItems: "center", padding: spacing.md, backgroundColor: colors.card, borderRadius: 8, gap: spacing.md, borderWidth: 1, borderColor: colors.border },
  menuText: { ...typography.body, color: colors.text, flex: 1 },
  logout: { borderColor: colors.expense },
});
